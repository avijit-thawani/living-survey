...
| --- | --- | --- |
| [Yoshua Bengio](demos/bengio/) | Every paper by Yoshua Bengio, with what to read next found automatically from their citations. · **816** in your list · **25** Recs | 2026-09-26 |
| [Noam Brown](demos/brown/) | Every paper by Noam Brown, with what to read next found automatically from their citations. · **110** in your list · **25** Recs | 2026-09-26 |
| [Jeff Dean](demos/dean/) | Every paper by Jeff Dean, with what to read next found automatically from their citations. · **39** in your list · **25** Recs | 2026-09-26 |
| [Chris Olah](demos/olah/) | Every paper by Chris Olah, with what to read next found automatically from their citations. · **27** in your list · **25** Recs | 2026-09-26 |
